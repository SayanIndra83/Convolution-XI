...
export default function Mentors() {
    ...
    return (
        <section id="judges" 
            className="relative w-full pt-20 md:pt-25 pb-5 flex flex-col items-center justify-center overflow-hidden bg-linear-to-b from-[#3a4511] via-[#525412] to-[#6b5e13]"
        >
            ...
            <div className='maxWidthForSections w-full flex flex-col items-center px-4'>
                ...
                <div className="flex justify-center md:flex-wrap lg:flex-nowrap flex-col md:flex-row gap-2 md:gap-x-6">
                    {mentors.map((mentor, index) => (
                        <div
                            key={index}
                            className="group hover:-translate-y-2 hover:bg-white/30 hover:shadow-[0_0_25px_rgba(250,204,21,0.4)] border border-transparent hover:border-yellow-400/40 transition-all duration-300 rounded-xl bg-white/20 shadow-black/20 shadow-md backdrop-blur-sm flex py-4 px-3 items-center gap-x-4 sm:max-w-[500px]"
                        >
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center gap-2 mb-1.5 text-white">
                                    ...
                                    <Link target="_blank" href={mentor.profile}>
                                        <FaInfoCircle className="hover:text-yellow-300 transition-colors duration-300" />
                                    </Link>
                                </div>
