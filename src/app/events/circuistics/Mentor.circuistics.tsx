            ...
            <div className='maxWidthForSections w-full flex flex-col items-center px-4'>
                ...
                >
                    ...
                    <p className="opacity-90 text-center text-white mt-3 text-base md:text-lg font-rajdhani font-bold tracking-wide">
                        Meet the Mentors of Circuistics!
                    </p>
                </motion.div>
                ...
                <div className="flex justify-center md:flex-wrap lg:flex-nowrap flex-col md:flex-row gap-2 md:gap-x-6">
                    {mentors.map((mentor, index) => (
                        <div
                            key={index}
                            className="group hover:-translate-y-2 hover:bg-white/30 hover:shadow-[0_0_25px_rgba(129,140,248,0.4)] border border-transparent hover:border-indigo-400/40 transition-all duration-300 rounded-xl bg-white/20 shadow-black/20 shadow-md backdrop-blur-sm flex py-4 px-3 items-center gap-x-4 sm:max-w-[500px]"
                        >
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center gap-2 mb-1.5 text-white">
                                    ...
                                    <Link target="_blank" href={mentor.profile}>
                                        <FaInfoCircle className="hover:text-indigo-300 transition-colors duration-300" />
                                    </Link>
                                </div>
